...
opt:
	emcc $(CFLAGS) boltzmann.c main.c -s TOTAL_MEMORY=20000000 -O3 $(CFLAGS) -o $(DIRECTORY)/main.html
...
opt2:
	clang $(CFLAGS) boltzmann.c main.c -O3 $(CFLAGS) -o $(DIRECTORY)/main-opt -lm -lSDL
